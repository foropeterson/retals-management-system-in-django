...
def contact(request):
    ...
    if request.method == 'POST':
        ...
        contact.save()
        context.update({'msg': 'message send to peterson'})
        return HttpResponse(template.render(context, request))
    else:
        context.update({'msg': ''})
        return HttpResponse(template.render(context, request))
...
def send_message(request):
    ...
    account_sid = settings.ACe2ce59a6e4039e05096df6146313aac4
    auth_token = settings.eaf1a59d0e1e158982d11f2c040a1292
    ...
    message = client.messages.create(
        from_='whatsapp:<+12694480545>',
        body='Hello from Django!',
        to='whatsapp:<0110173956>'
    )
